\chapter{Steady state probabilities (closed-form)}
...
\begin{figure}[H]
    \centering
    \input{chapters/03_queueing_model/Bin/graph_theory_examples/graph.tex}
    % <!-- alex ignore simple -->
...
\begin{figure}[H]
    \centering
    \input{chapters/03_queueing_model/Bin/graph_theory_examples/directed_graph.tex}
...
\begin{figure}[H]
    \centering
    \input{chapters/03_queueing_model/Bin/graph_theory_examples/weighted_directed_graph.tex}
    \caption{An example of a weighted directed graph with \(5\) vertices and
    \(7\) edges.}
    \label{fig:example_of_weighted_directed_graph}
\end{figure}

\section{A graph theoretic model underlying the Markov chain}
...
\begin{figure}[H]
    \centering
    \scalebox{0.7}{
        \input{chapters/03_queueing_model/Bin/example_model_1352/main.tex}
        }
...
\section{Spanning Trees rooted at (0,0)}
...
\begin{figure}[H]
    \centering
    \input{chapters/03_queueing_model/Bin/example_model_1121/main.tex}
\end{figure}

\begin{multicols}{2}
    \begin{center}
        \scalebox{0.9}{
            \input{chapters/03_queueing_model/Bin/spanning_trees_1121/main_0.tex}
        }
    \end{center}
...
\begin{multicols}{2}
    \begin{center}
        \scalebox{0.9}{
            \input{chapters/03_queueing_model/Bin/spanning_trees_1121/main_1.tex}
        }
    \end{center}
...
\begin{figure}[H]
    \centering
    \input{chapters/03_queueing_model/Bin/example_model_1131/main.tex}
\end{figure}
...
\begin{multicols}{2}
    \begin{figure}[H]
        \centering
        \scalebox{0.7}{
            \input{chapters/03_queueing_model/Bin/spanning_trees_1131/main_0.tex}}
    \end{figure}
...
\begin{multicols}{2}
    \begin{figure}[H]
        \centering
        \scalebox{0.7}{
            \input{chapters/03_queueing_model/Bin/spanning_trees_1131/main_1.tex}}
    \end{figure}
...
\begin{multicols}{2}
    \begin{figure}[H]
        \centering
        \scalebox{0.7}{
            \input{chapters/03_queueing_model/Bin/spanning_trees_1131/main_2.tex}}
    \end{figure}
...
\begin{multicols}{2}
    \begin{figure}[H]
        \centering
        \scalebox{0.7}{
            \input{chapters/03_queueing_model/Bin/spanning_trees_1131/main_3.tex}}
    \end{figure}
...
\begin{multicols}{2}
    \begin{figure}[H]
        \centering
        \scalebox{0.7}{
            \input{chapters/03_queueing_model/Bin/spanning_trees_1131/main_4.tex}}
    \end{figure}
...
\begin{figure}[H]
    \centering
    \input{chapters/03_queueing_model/Bin/example_model_1122/main.tex}
\end{figure}
...
\begin{multicols}{4}
    \begin{figure}[H]
        \centering
        \scalebox{0.48}{
            \input{chapters/03_queueing_model/Bin/spanning_trees_1122/main_0.tex}}
    \end{figure}
    \vspace*{\fill}
    \columnbreak
    \vspace*{0cm}
    ...
    \begin{figure}[H]
        \centering
        \scalebox{0.48}{
            \input{chapters/03_queueing_model/Bin/spanning_trees_1122/main_1.tex}}
    \end{figure}
    \vspace*{\fill}
    \columnbreak
    \vspace*{0.3cm}
...
\begin{multicols}{4}
    \begin{figure}[H]
        \centering
        \scalebox{0.48}{
            \input{chapters/03_queueing_model/Bin/spanning_trees_1122/main_2.tex}}
    \end{figure}
    \vspace*{\fill}
    \columnbreak
    \begin{equation*}
    ...
    \begin{figure}[H]
        \centering
        \scalebox{0.48}{
            \input{chapters/03_queueing_model/Bin/spanning_trees_1122/main_3.tex}}
    \end{figure}
    \vspace*{\fill}
    \columnbreak
    \begin{equation*}
...
\section{Conjecture of adding rows}
...
\begin{figure}[H]
    ...
    \scalebox{0.65}{
        \input{chapters/03_queueing_model/Bin/example_model_1122/main.tex}}
    \scalebox{0.65}{
        \input{chapters/03_queueing_model/Bin/example_model_1123/main.tex}}
...
\section{The effect of increasing N}
...
\begin{figure}[H]
    \centering
    \scalebox{0.8}{
        \input{chapters/03_queueing_model/Bin/example_model_1141/main.tex}}
\end{figure}
...
\begin{figure}[H]
    \centering
    \scalebox{0.8}{
        \input{chapters/03_queueing_model/Bin/example_model_1151/main.tex}}
\end{figure}
...
\section{Examples of mappings of directed spanning trees to permutation arrays}
...
\section{Closed-form approach for state probabilities}
...
\section{Example of the permutation algorithm}
