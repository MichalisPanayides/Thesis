...
This thesis aims to explore the behaviour that emerges from a competitive
...
in Appendix. % TODO: ~\ref{app:ambulance_game}.
...
It also acts as a frontend to to Continuous Integration (CI) servers such as
