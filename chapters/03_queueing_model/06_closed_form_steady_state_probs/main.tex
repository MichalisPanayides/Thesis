...
\paragraph{Example figure of Markov Model}
...
about all these edges that belong in \(S\) the problem can be slightly
simplified.
...
% \paragraph{Possibly useful theorem: Matrix-tree theorem for directed graphs
