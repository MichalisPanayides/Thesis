...
\begin{figure}[H]
    \centering
    \scalebox{0.75}{\input{chapters/03_queueing_model/Bin/example_model_1242/main.tex}}
...
\begin{figure}[H]
    \centering
    \scalebox{0.75}{\input{chapters/03_queueing_model/Bin/example_model_2242/main.tex}}
...
By observing equation~\eqref{eq:general_cdf_hypoexponential} once more, the range
...
described in equation~\eqref{eq:cdf_erlang}.
