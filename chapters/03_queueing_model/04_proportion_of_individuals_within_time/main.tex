...
The complexity of such a task lies on the fact that different individuals
...
are \(C=1\), just like in the explored example, or when an individual arrives
...
\ref{eq:multiple_servers_distribution_example}, is the sum of just two
...
\ref{eq:example_direct_approach_blocking_time}.
