\section{Queueing theoretic model}\label{sec:queueing_section}
...
In Section~\ref{sec:queueing_ems_es_application} this queueing network will be
...
\input{chapters/03_queueing_model/06_closed_form_steady_state_probs/main.tex}
...
\input{chapters/03_queueing_model/05_numeric_results_and_timings/main.tex}

\input{chapters/03_queueing_model/07_ed_ems_application/main.tex}