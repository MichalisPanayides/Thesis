...
\begin{itemize}
    ...
    blocked
    \item \(N\): The capacity of waiting zone 1 (i.e \(N=C + 
    \text{(Queue capacity)}\))
    \item \(M\): The capacity of waiting zone 2
\end{itemize}
...
these performance measures; a direct approach, a recursive algorithm and
