...
The class \texttt{CustomNode} inherits from
\texttt{ciw.Node} and changes two of the methods
...
explanation of how to calculate these performance measures using just the
