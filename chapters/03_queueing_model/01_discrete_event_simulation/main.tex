...
needed.
The following code can be used to generate a simple queueing network with two
...
Another very specific feature of the particular model is that type 2 individuals
...
...     The methods are modified in such a way such that all individuals that
...     are in the buffer space node (node 1) remain blocked as long as the
...
node 1 to node 2.
This basically checks whether the id of the node is 2 and
