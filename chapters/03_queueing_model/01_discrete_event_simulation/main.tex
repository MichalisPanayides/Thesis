...
Discrete Event Simulation (DES) is a method for modelling the behaviour of real-world systems in which the
...
Figure~\ref{fig:diagram_of_queueing_system} an equivalent queueing network must be constructed.
...
capacity. As shown in Figure % TODO Add figure caption.
...
Note here that, similar to Figure % TODO add caption
