...
filenames = [
    "data/waiting_time_recursive_N.csv",
    "data/waiting_time_direct_N.csv",
    "data/waiting_time_closed_form_N.csv",
]

filenames_duration = [
    "data/duration_recursive_N.csv",
    "data/duration_direct_N.csv",
    "data/duration_closed_form_N.csv",
]
