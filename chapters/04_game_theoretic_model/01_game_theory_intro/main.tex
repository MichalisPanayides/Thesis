...
equilibrium of a 2-player normal form game.
Note that the algorithm is only applicable to 2-player normal form games and
the algorithm outputs just one Nash equilibrium.
The Lemke-Howson algorithm uses the concept of support enumeration described in
% TODO: cite Nisan, Noam, et al., eds. Algorithmic game theory. Vol. 1. Cambridge: Cambridge University Press, 2007.
that is used to find all pairs of best responses for a given game.
For a non-degenerate 2-player game the Lemke-Howson algorithm performs the
following steps:
% TODO: cite Lemke, Carlton E., and Joseph T. Howson, Jr. "Equilibrium points of bimatrix games." Journal of the Society for Industrial and Applied Mathematics 12.2 (1964): 413-423.
...
non-degenerate 2-player normal form game by using all possible pairs of support
of a game.
% TODO: cite non-degenerate
% TODO: cite support
...
\(B\):
% TODO: cite support enumeration
% https://ieeexplore.ieee.org/abstract/document/6747409
...
In order to overcome this problem, evolutionary stable strategies (ESS)
have been introduced~\cite{nowak1993evolutionary}.
Learning algorithms can be used to reach certain ESS of a game.
Note that all ESS that arise from learning algorithms are also Nash
equilibria.
% TODO: ESS paragrpah, definition, etc.

\subsubsection{Fictitious play}
One such learning algorithm is called Fictitious play.
% TODO: cite fictitious play (George W. Brown)
% TODO: cite Fudenberg 1998
...
Another similar learning algorithm is called stochastic fictitious play.
% TODO: cite Hofbauer 2002, Fudenberg 1998
Stochastic fictitious play is a variation of the fictitious play algorithm
where a stochastic pertubation \(\epsilon_i\) is added to each expected payoff
...
which is also very similar to the fictitious play outcome.
...
replicator dynamics.
% TODO: cite Elvio, Accinelli and Carrera, Edgar. 2011. Evolutionarily Stable Strategies and Replicator Dynamics in Asymmetric Two-Population Games. 10.1007/978-3-642-11456-4_3.
Replicator dynamics is a learning algorithm that is used to express the
evolutionary dynamics of a population of players.
% TODO: cite Komarova, Natalia L. “Replicator–mutator equation, universality property and population dynamics of learning.” Journal of theoretical biology 230.2 (2004): 227-239.
Conider a large population of some agents, also known as replicators.
Different types of such replicators meet and interact with each other.
...
Different strategies from \(S^A\) are assiigned among the population of type
