...
\begin{figure}[H]
    \centering
    \input{chapters/04_game_theoretic_model/img/game_diagram.tex}
...
In essence this means that for either queueing system  (A or B), every strategy
...
\begin{figure}[H]
    \centering
    \scalebox{0.8}{
        \input{chapters/04_game_theoretic_model/img/strategy_visualisation_N_6_M_3/main_1.tex}
    }
    \caption{\(T_A = 1\)}
...
\begin{figure}[H]
    \centering
    \scalebox{0.8}{
        \input{chapters/04_game_theoretic_model/img/strategy_visualisation_N_6_M_3/main_2.tex}
    }
    \caption{\(T_A = 2\)}
\end{figure}
...
\begin{figure}[H]
    \centering
    \scalebox{0.8}{
        \input{chapters/04_game_theoretic_model/img/strategy_visualisation_N_6_M_3/main_3.tex}
    }
    \caption{\(T_A = 3\)}
\end{figure}
...
\begin{figure}[H]
    \centering
    \scalebox{0.8}{
        \input{chapters/04_game_theoretic_model/img/strategy_visualisation_N_6_M_3/main_4.tex}
    }
    \caption{\(T_A = 4\)}
\end{figure}
...
\begin{figure}[H]
    \centering
    \scalebox{0.8}{
        \input{chapters/04_game_theoretic_model/img/strategy_visualisation_N_6_M_3/main_5.tex}
    }
    \caption{\(T_A = 5\)}
\end{figure}
...
\begin{figure}[H]
    \centering
    \scalebox{0.8}{
        \input{chapters/04_game_theoretic_model/img/strategy_visualisation_N_6_M_3/main_6.tex}
    }
    \caption{\(T_A = 6\)}
...
% TODO: The above sentence is correct but maybe needs some rewording.
...
\begin{figure}[H]
    \input{chapters/04_game_theoretic_model/img/game_diagram_objectives.tex}
...
% TODO: Is importance parameter a good name?
...
\begin{figure}[H]
    \centering
    \input{chapters/04_game_theoretic_model/img/imperfect_info_game_diagram.tex}
