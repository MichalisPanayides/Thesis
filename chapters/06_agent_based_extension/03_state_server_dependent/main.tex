...
% TODO: Mention implementation - either referecne GitHub repo or have a chapter that explains the code.
...
For the complete notation of the parameters see
Section~\ref{sec:game_players_and_parameters}.
% TODO: Maybe reference list of notations here instead of this section.
