...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{chapters/05_numerical_results/Bin/example_1/main.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{chapters/05_numerical_results/Bin/example_2/main.pdf}
...
For the purpose of this study a new concept is introduced that considers the
...
% TODO: Should there be more examples? Are these enough? Maybe investigate
%       some more examples with different parameter sets.
